...
export default function EditIngredientPage() {
  ...
  useEffect(() => {
    ...
    getIngredient(ingredientId)
      ...
      .catch((err: any) => setError(err?.message || "failed to load ingredient details"))
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center p-20 text-center">
        ...
        <p className="mt-4 text-sm text-slate-500 font-medium">Loading ingredient details...</p>
      </div>
    );
  }
    ...
    <div className="mx-auto w-full max-w-2xl space-y-6 animate-fade-in pb-12">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Change the details of the active skincare ingredient, description, or function.</p>
        </div>
        <Link 
